...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'tuxsec.context_processors.modules_context',
            ],
        },
    },
]

WSGI_APPLICATION = 'tuxsec.wsgi.application'
...
#         'NAME': config('DB_NAME', default='tuxsec_db'),
#         'USER': config('DB_USER', default='tuxsec_user'),
#         'PASSWORD': config('DB_PASSWORD', default='tuxsec_pass'),
